...
<div class="grid grid-cols-1 gap-8 p-4">
    <div class="flex flex-col gap-4">
        <p class="text-3xl font-bold">Privacy Policy</p>
        <p>
            Sad Ellie built the Unitto app as an Open Source app. This SERVICE
            is provided by Sad Ellie at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
            ...
            our Terms and Conditions, which are accessible at Unitto unless
            otherwise defined in this Privacy Policy.
        </p>
        <p class="text-2xl font-medium">Information Collection and Use</p>
        <p>
        ...
        <p class="text-2xl font-medium">Service Providers</p>
        <p>
        ...
        <p class="text-2xl font-medium">Security</p>
        <p>
        ...
        <p class="text-2xl font-medium">Links to Other Sites</p>
        <p>
        ...
        <p class="text-2xl font-medium">Children’s Privacy</p>
        <p>
        ...
        <p class="text-2xl font-medium">Changes to This Privacy Policy</p>
        <p>
