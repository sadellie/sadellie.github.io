...
<div class="grid grid-cols-1 gap-8 p-4">
    <div class="flex flex-col gap-4">
        <p class="text-3xl font-bold">Terms &amp; Conditions</p>
        <p>
            ...
            related to it, still belong to Sad Ellie.
        </p>
        <p>
            Sad Ellie is committed to ensuring that the app is as useful and
        ...
        <p>
            The Unitto app stores and processes personal data that you have
            ...
            phone’s security features and it could mean that the Unitto app
            won’t work properly or at all.
        </p>
        <p>
            You should be aware that there are certain things that Sad Ellie
            ...
            but Sad Ellie cannot take responsibility for the app not working at
        ...
        <p>
            Along the same lines, Sad Ellie cannot always take responsibility
            ...
            it on to avail the Service, Sad Ellie cannot accept responsibility.
        </p>
        <p>
            With respect to Sad Ellie’s responsibility for your use of the app,
            ...
            that we can make it available to you. Sad Ellie accepts no liability
        ...
        <p>
            ...
            to keep using the app. Sad Ellie does not promise that it will
        ...
        <p class="text-2xl font-medium">Changes to This Terms and Conditions</p>
        <p>
        ...
        <p>
            ...
            Conditions, do not hesitate to contact me at <a
