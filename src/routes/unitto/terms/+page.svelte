...
<div class="grid grid-cols-1 gap-8 p-4">
  <div class="flex flex-col gap-4">
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Sad Ellie.
    </p>
    <p>
    ...
    <p>
      The Unitto app stores and processes personal data that you have provided
      ...
      features and it could mean that the Unitto app won’t work properly or at
      all.
    </p>
    <p>
    ...
    <p>
      ...
      that the terms of the agreement with your mobile network provider will
    ...
    <p>
      ...
      the app. Sad Ellie does not promise that it will always update the app so
