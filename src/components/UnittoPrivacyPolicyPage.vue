...
<template>
    <div class="flex flex-col gap-4">
        ...
        <p>
            Sad Ellie built the Unitto app as a Free app. This SERVICE is provided by Sad Ellie at no cost and is
        ...
        <p>
            ...
            this
            policy. The Personal Information that I collect is used for providing and improving the Service. I will
            not
        ...
        <p>
            ...
            accessible at Unitto unless otherwise defined in this Privacy Policy.
        </p>
        ...
        <ul class="list-disc list-inside">
            <li>
                <UnittoTextLink href="https://www.google.com/policies/privacy/">
                    Google Play Services
                </UnittoTextLink>
            </li>
            <li>
                <UnittoTextLink href="https://firebase.google.com/policies/analytics">
                    Google Analytics for Firebase
                </UnittoTextLink>
            </li>
            <li>
                <UnittoTextLink href="https://firebase.google.com/support/privacy/">
        ...
        <p>
            ...
            <UnittoTextLink href="https://privacypolicytemplate.net">
