...
import UnittoTextH1 from './UnittoTextH1.vue';
import UnittoTextLink from './UnittoTextLink.vue';
...
<template>
  <div class="flex flex-col gap-4">
    ...
    <p>
      ...
      trademarks, copyright, database rights, and other intellectual property rights related to it, still belong to Sad
      Ellie.
    </p>

    <p>
      Sad Ellie is committed to ensuring that the app is as useful and efficient as possible. For that reason, we
    ...
    <p>
      The Unitto app stores and processes personal data that you have provided to us, to provide my Service. It’s your
      ...
      compromise your phone’s security features and it could mean that the Unitto app won’t work properly or at all.
    </p>
    <p>
    ...
    <ul class="list-disc list-inside">
      <li>
        <UnittoTextLink href="https://policies.google.com/terms">
          Google Play Services
        </UnittoTextLink>
      </li>
      <li>
        <UnittoTextLink href="https://firebase.google.com/terms/analytics">
          Google Analytics for Firebase
        </UnittoTextLink>
      </li>
      <li>
        <UnittoTextLink href="https://firebase.google.com/terms/crashlytics">
    ...
    <p>
      You should be aware that there are certain things that Sad Ellie will not take responsibility for. Certain
      functions of the app will require the app to have an active internet connection. The connection can be Wi-Fi or
      provided by your mobile network provider, but Sad Ellie cannot take responsibility for the app not working at full
    ...
    <p>
      Along the same lines, Sad Ellie cannot always take responsibility for the way you use the app i.e. You need to
      make sure that your device stays charged – if it runs out of battery and you can’t turn it on to avail the
      Service, Sad Ellie cannot accept responsibility.
    </p>


    <p>
      With respect to Sad Ellie’s responsibility for your use of the app, when you’re using the app, it’s important to
      bear in mind that although we endeavor to ensure that it is updated and correct at all times, we do rely on third
      parties to provide information to us so that we can make it available to you. Sad Ellie accepts no liability for
    ...
    <p>
      ...
      need to download the updates if you want to keep using the app. Sad Ellie does not promise that it will always
    ...
    <p>
      ...
      <UnittoTextLink href="mailto:sadellie.dev@gmail.com">
    ...
    <p>
      ...
      <UnittoTextLink href="https://app-privacy-policy-generator.nisrulz.com/">
